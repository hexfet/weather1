...
use_api_for_html = True  # use WEB service for HTML minify
...
content_folder = "./web_content/" # input folder
result_file = "./web_content.h" # output file
...
def getListOfFiles(dirName):
    ...
    print("current dir: " + os.getcwd() + ", dirName: " + dirName)
